  ...
  <el-container style="width: 100%">
    ...
    <el-main>
      ...
      >
            ...
            <dl>
              ...
              <div v-if="recordsNum == 0">
                <div style="display: flex; margin-bottom: 15px">
                  <div>
                    <h1>
                      抱歉没有找到与<span style="color: black">{{
                        search_word
                      }}</span
                      >相关的文本。
                    </h1>
        ...
        <el-row>
          <!-- 相关搜索 -->
          <h3 style="width: 100px; margin-left: 100px; color: black">
            相关搜索
          </h3>
          <div id="allrelated">
            <div
...
export default {
  ...
  methods: {
    ...
    async getRelatedWord() {
      let outer = this;
      await axios
        .get("/related_word?word=" + outer.search_word)
        .then((response) => (outer.info = response.data));
    ...
    async querySearchAsync(queryString, cb) {
      ...
      if (queryString == '') {
        ...
        await axios
            .get("/prefix_word?word=" + this.search_word)
            .then((response) => {
              data = response.data
            })
